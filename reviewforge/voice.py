...
class Voice:
    ...
    def __init__(self, audio_format="wav", device_name=None):
        try:
            ...
            raise SoundDeviceError("soundfile not available. Install it with: pip install soundfile")
        ...
        try:
            ...
            raise SoundDeviceError("sounddevice not available. Install it with: pip install sounddevice")
    ...
    def raw_record_and_transcribe(self, history, language):
        ...
        try:
            ...
            with self.sd.InputStream(
                ...
                pt_prompt(self.get_prompt, refresh_interval=0.1)
        except self.sd.PortAudioError as err:
            raise SoundDeviceError(f"Error accessing audio input device: {err}")

        with self.sf.SoundFile(temp_wav, mode="x", samplerate=sample_rate, channels=1) as file:
